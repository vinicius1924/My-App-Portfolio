...
public class MoviesPostersRecyclerAdapter extends RecyclerView.Adapter<MoviesPostersRecyclerAdapter.CustomViewHolder>
{
	...
	@Override
	public MoviesPostersRecyclerAdapter.CustomViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
	{
	...
	@Override
	public void onBindViewHolder(MoviesPostersRecyclerAdapter.CustomViewHolder customViewHolder, int position)
	{
